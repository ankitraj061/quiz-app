...
export const getVerficationMailTemplate = (
  studentName: string,
...
export const getWelcomeMailTemplate = (
  studentName: string,
  teamName: string,
  email: string,
  leaderName: string
...
<body>
    <div class="email-wrapper">
        ...
        <div class="content">
            ...
            <div class="message">
                We received a request to reset the password for your Quiz App account. If you didn't make this request, you can ignore this email.
            </div>
        ...
        <div class="footer">
            ...
            <p style="margin-top: 15px;">© 2025 Quiz App. All rights reserved.</p>
        </div>
    </div>
</body>
</html>`;
